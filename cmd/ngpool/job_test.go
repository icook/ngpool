...
func TestAuxBranch(t *testing.T) {
	input := [][]byte{
		[]byte{0x8c, 0x16, 0xb2, 0x5c, 0x0f, 0x0b, 0xb5, 0x28, 0xb1, 0x0f,
			0x85, 0x52, 0x1b, 0xf1, 0xf6, 0x6c, 0xad, 0xe4, 0x07, 0x9d, 0x15, 0x13,
			0xab, 0xd6, 0xd5, 0x87, 0xee, 0xb2, 0x0d, 0xa1, 0x9b, 0x99},
		nil,
		[]byte{0xc3, 0x45, 0xef, 0x97, 0x4f, 0x1d, 0xb2, 0xa4, 0xcc, 0x81,
			0x05, 0xa6, 0x70, 0x31, 0xac, 0x4b, 0xdc, 0xcc, 0x85, 0xa5, 0xb5, 0x11,
			0xca, 0x6b, 0xc4, 0x65, 0x6f, 0x57, 0x9c, 0x5a, 0x09, 0xb3},
		nil,
	}
	correct := [][]uint8{
		[]uint8{0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
			0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0,
			0x0, 0x0, 0x0, 0x0, 0x0, 0x0},
		[]uint8{0x94, 0x99, 0x41, 0x1d, 0x25, 0xa8, 0x3, 0x12, 0x1b, 0x52,
			0x2b, 0xc4, 0x15, 0x12, 0xf7, 0x30, 0x99, 0x90, 0xe5, 0xfc, 0x1f, 0x47,
			0x22, 0x6e, 0x94, 0xbd, 0xc, 0x8f, 0xa8, 0xf8, 0xea, 0x59},
	}
	branch, mask := auxMerkleBranch(input, input[2])
	spew.Dump(branch)
	assert.Equal(t, uint32(1), mask)
	assert.Equal(t, correct, branch)
}
